...
description: The Trap of delegating critical thinking to AI
...
The danger is that too many engineers and product managers are letting go of the rope. They tie the safety rope to a loose rock and walk away to do something else while the AI keeps climbing. When we let AI to take the lead in vision, design or architecture, we have let go of the rope. We stop being the anchor of critical thinking and start passively following wherever the AI leads.
...
AI doesn't only help with major decisions; it also assists us daily in our work. We're seeing more AI-generated communication, like: Slack messages, emails, and comments on documents. While it may feel efficient and save time, it creates a communication barrier. 

When I receive a perfectly polished Slack update clearly written by AI, I’m reading words the sender didn't fully process or even care about. This undermines the authenticity of human communication.
...
Let AI generate boilerplate code, find bugs, refactor, implement proof of concept, summarize large amount of documentation you don't have time to read, and suggest alternative options. Do not let it decide what to build, how you build it, nor the architecture foundation of your system. We are the safety line. We keep our hands on the rope, keep our eyes on the climber, and do our own thinking.
