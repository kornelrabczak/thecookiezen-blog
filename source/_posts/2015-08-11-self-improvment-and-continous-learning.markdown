...
comments: true
description: Self improvement and continuous learning
keywords: improvement, learning, blog, books, courses, conferences, work
categories: [improvement, learning]
---

-> {% img center-displayed /images/1.jpg 'image' 'images' %} <-
...
-> {% img center-displayed /images/2.JPG 'image' 'images' %} <-
...
-> {% img center-displayed /images/3a.jpg 300 300 'image' 'images' %} <-
...
-> {% img center-displayed /images/4.jpg 600 400 'image' 'images' %} <-
...
-> {% img center-displayed /images/5.jpg 600 500 'image' 'images' %}  <br/><sup>pic from i.ytimg.com</sup> <-
